...
for (const l of lessons) {
  l.questions = lessonQuestionsMap[l.id] || (l.question ? [l.question] : []);
  l.question = l.questions[0];
}
export const questions = lessons.flatMap(l => (l.questions || [l.question]).map(q => ({ ...q, lessonId: l.id })));
